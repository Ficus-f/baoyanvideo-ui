<template>
  <baoyan-login-logo></baoyan-login-logo>
  <div class="sign">
    <div class="sign-head">
      <span>用户注册</span>
    </div>
    <el-form ref="signUpForm" label-width="70px" status-icon :model="registerForm" :rules="SignUpRules">
      ...
      <el-form-item prop="introduction" label="简介">
        <el-input type="textarea" placeholder="简介" v-model="registerForm.introduction"></el-input>
      </el-form-item>
...
import BaoyanLoginLogo from "@/components/layouts/BaoyanLoginLogo.vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    async function handleSignUp() {
      ...
      // params.append("birth", toRFC3339(registerForm.birth));
