<template>
  <div class="personal">
    <div class="personal-info">
      <el-image class="personal-img" fit="contain" :src="getImageUrl(userPic)" @click="dialogTableVisible = true" />
    ...
    <!-- <div class="personal-body">
      <course-list :courseList="collectionCourseList" path="course-detail" :show="true" @changeData="changeData"></course-list>
    </div> -->
