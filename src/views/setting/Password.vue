...
export default defineComponent({
  setup() {
    ...
    const rules = reactive({
      oldPassword: [{ validator: validatePassword, trigger: "blur", min: 6 }],
      newPassword: [{ validator: validatePassword, trigger: "blur", min: 6 }],
      confirmPassword: [{ validator: validateCheck, trigger: "blur", min: 6 }],
    });
